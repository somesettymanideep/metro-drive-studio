...
export function MetroFooter() {
  return (
    <footer className="relative bg-black text-white pt-12 pb-3 lg:pb-2 border-t border-white/5 overflow-hidden">
      <div
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70 text-sm">
              ...
              <li className="flex gap-3"><Clock className="size-4 text-[var(--brand-orange)] shrink-0 mt-0.5" /> Mon–Sun: 10:00 AM – 9:00 PM</li>
            </ul>
          </div>
        </div>
